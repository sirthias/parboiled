...
public class NopParseErrorHandler<V> implements ParseErrorHandler<V> {
    ...
    private static NopParseErrorHandler instance;

    @SuppressWarnings({"unchecked"})
    @NotNull
    public static <V> NopParseErrorHandler<V> instance() {
        if (instance == null) {
            instance = new NopParseErrorHandler<V>();
        }
        return (NopParseErrorHandler<V>)instance;
    }
