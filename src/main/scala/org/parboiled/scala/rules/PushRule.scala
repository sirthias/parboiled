...
class Rule1[+A](matcher: Matcher) extends PushRule(matcher: Matcher) {
  ...
  def ~>[R](f: String => R): Rule2[A, R] @uncheckedVariance = new Rule2[A, R](append(push(exec(GetMatch, f))))
...
class Rule2[+A, +B](matcher: Matcher) extends PushRule(matcher: Matcher) {
  ...
  def ~>[R](f: String => R): Rule3[A, B, R] @uncheckedVariance = new Rule3[A, B, R](append(push(exec(GetMatch, f))))
...
class Rule3[+A, +B, +C](matcher: Matcher) extends PushRule(matcher: Matcher) {
  ...
  def ~>[R](f: String => R): Rule4[A, B, C, R] @uncheckedVariance = new Rule4[A, B, C, R](append(push(exec(GetMatch, f))))
...
class Rule4[+A, +B, +C, +D](matcher: Matcher) extends PushRule(matcher: Matcher) {
  ...
  def ~>[R](f: String => R): Rule5[A, B, C, D, R] @uncheckedVariance = new Rule5[A, B, C, D, R](append(push(exec(GetMatch, f))))
...
class Rule5[+A, +B, +C, +D, +E](matcher: Matcher) extends PushRule(matcher: Matcher) {
  ...
  def ~>[R](f: String => R): Rule6[A, B, C, D, E, R] @uncheckedVariance = new Rule6[A, B, C, D, E, R](append(push(exec(GetMatch, f))))
...
class Rule6[+A, +B, +C, +D, +E, +F](matcher: Matcher) extends PushRule(matcher: Matcher) {
  ...
  def ~>[R](f: String => R): Rule7[A, B, C, D, E, F, R] @uncheckedVariance = new Rule7[A, B, C, D, E, F, R](append(push(exec(GetMatch, f))))
