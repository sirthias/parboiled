...
define "parboiled" do
  ...
  define "parboiled-java" do
    compile.with ASM_ALL, project("parboiled-core")
    test.with TESTNG
    test.using :testng
    package :jar
  end
  ...
  define "parboiled-scala" do
    compile.with project("parboiled-core")
    test.with SCALATEST
    test.using :testng
    package :jar
  end
  ...
  define "examples-java" do
    compile.with project("parboiled-java")
    test.with TESTNG
    test.using :testng
    package :jar
  end
  ...
  define "examples-scala" do
    compile.with project("parboiled-scala")
    test.with SCALATEST
    test.using :testng
    package :jar
  end
