The package "org.parboiled.examples":http://github.com/sirthias/parboiled/tree/master/src/examples/scala/org/parboiled/examples/
contains subpackages for each _parboiled for Scala example.
