...
This, plus the fact that to many people trees are a more common mental picture, you might choose to think of the rule graph as a rule "tree" with two potential exceptions: multi-parent nodes and loop-backs.
