_parboiled_ was born out of frustration over existing parser building tools for the JVM. The huge increase in popularity dynamic languages (like Ruby or Groovy) have seen in recent years stems to a good part from the ease with which they lend themselves to the modeling of "Domain Specific Languages":http://en.wikipedia.org/wiki/Domain_Specific_Language (DSLs).
