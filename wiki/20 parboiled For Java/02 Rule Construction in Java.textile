...
| "AnyOf":http://sirthias.github.com/parboiled/javadoc/org/parboiled/BaseParser.html#AnyOf(java.lang.String) (string) | Matches any one of the given strings characters (faster than a similar _FirstOf_ ) |
| "IgnoreCase":http://sirthias.github.com/parboiled/javadoc/org/parboiled/BaseParser.html#IgnoreCase(char) (char) | Matching one single character case-independently |
| "IgnoreCase":http://sirthias.github.com/parboiled/javadoc/org/parboiled/BaseParser.html#IgnoreCase(java.lang.String) (string) | Matching a given string case-independently |
