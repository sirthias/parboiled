...
In order to give you more flexibility in action design _parboiled for Java_ offers you a second tool that might prove valueable whenever the value stack somehow doesn't seem to fit.
...
Consider the following rule example, which is part of the "pegdown Markdown parser":http://github.com/sirthias/pegdown/blob/master/src/org/pegdown/MarkDownParser.java:
