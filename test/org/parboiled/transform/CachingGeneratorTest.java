...
public class CachingGeneratorTest {
    ...
    public void testReturnInstructionUnification() throws Exception {
        ...
        assertTraceDumpEquality(getMethodByName(classNode.cachedMethods, "ch"), "" +
                ...
                "    ALOAD 0\n" +
                "    GETFIELD org/parboiled/transform/TestParser$$parboiled.cache$ch : Ljava/util/HashMap;\n" +
                "    DUP\n" +
                "    IFNONNULL L0\n" +
                "    POP\n" +
                "    ALOAD 0\n" +
                ...
                "    PUTFIELD org/parboiled/transform/TestParser$$parboiled.cache$ch : Ljava/util/HashMap;\n" +
                "   L0\n" +
                "    ILOAD 1\n" +
        ...
        assertTraceDumpEquality(getMethodByName(classNode.cachedMethods, "optional"), "" +
                ...
                "    ALOAD 0\n" +
                "    GETFIELD org/parboiled/transform/TestParser$$parboiled.cache$optional : Ljava/util/HashMap;\n" +
                "    DUP\n" +
                "    IFNONNULL L0\n" +
                "    POP\n" +
                "    ALOAD 0\n" +
                ...
                "    DUP\n" +
                "    INVOKESPECIAL java/util/HashMap.<init> ()V\n" +
                "    PUTFIELD org/parboiled/transform/TestParser$$parboiled.cache$optional : Ljava/util/HashMap;\n" +
                "   L0\n" +
                "    ALOAD 1\n" +
                "    DUP\n" +
                "    ASTORE 2\n" +
                ...
                "    ALOAD 0\n" +
                "    ALOAD 1\n" +
                "    INVOKESPECIAL org/parboiled/transform/TestParser.optional (Ljava/lang/Object;)Lorg/parboiled/Rule;\n" +
                "    DUP\n" +
                "    INSTANCEOF org/parboiled/matchers/AbstractMatcher\n" +
                "    IFEQ L2\n" +
                "    CHECKCAST org/parboiled/matchers/AbstractMatcher\n" +
        ...
        assertTraceDumpEquality(getMethodByName(classNode.ruleMethods, "empty"), "" +
                "    ALOAD 0\n" +
                "    GETFIELD org/parboiled/transform/TestParser$$parboiled.cache$empty : Lorg/parboiled/Rule;\n" +
                "    DUP\n" +
                "    IFNULL L0\n" +
                "    ARETURN\n" +
                "   L0\n" +
                ...
                "    ALOAD 0\n" +
                "    INVOKESPECIAL org/parboiled/transform/TestParser.empty ()Lorg/parboiled/Rule;\n" +
                "    DUP\n" +
                "    INSTANCEOF org/parboiled/matchers/AbstractMatcher\n" +
                "    IFEQ L1\n" +
                "    CHECKCAST org/parboiled/matchers/AbstractMatcher\n" +
